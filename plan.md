...
### [x] FAZ 1: MERKEZİ YÖNETİM VE ALTYAPI (Foundation)
...
### [x] FAZ 2: VERİ BORU HATTI (Data Pipeline & Preprocessing)
...
### [x] FAZ 3: MODELLEME KATMANI (Adapter & Pipeline Patterns)
...
### [x] FAZ 4: DENEY ORKESTRASYONU (Orchestrator)
...
### [x] FAZ 5: OLAY GÜDÜMLÜ RAPORLAMA, İSTATİSTİK VE AÇIKLANABİLİRLİK (Reporting & Explainability)
...
### [x] FAZ 6: GÖRSELLEŞTİRME KATMANI (VisualizationManager)

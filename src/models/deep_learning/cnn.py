...
class CNN1DModel(nn.Module):
    ...
    def __init__(self, n_features: int, window_size: int):
        ...
        # padding işlemi zaman serisi boyutunun aşırı küçülmesini engellemek
        # için eklenebilir
        padding = kernel_size // 2

        # nn.Conv1d girdi olarak (Batch, Channels, Length) bekler.
        # Bizim SlidingWindowDataset'imiz (Batch, Length/Window,
        # Features/Channels) dönmektedir.
        ...
        self.conv_block2 = nn.Sequential(
            ...
            nn.AdaptiveAvgPool1d(
                1
            ),  # Çıktıyı (Batch, num_filters_2, 1) boyutuna sabitler
        )

        # Sınıflandırma Katmanı
        self.classifier = nn.Sequential(nn.Linear(num_filters_2, 1), nn.Sigmoid())

...
class SAXTransformer:
    ...
    Sayısal zaman serisini (genelde PAA çıktısı) istatistiksel normal dağılım 
    ...
    def __init__(self):
        ...
        # norm.ppf (Percent Point Function), cdf'in tersidir ve bize çan eğrisi altındaki 
        # eşit alanlı dilimlerin x eksenindeki kesim noktalarını verir.
